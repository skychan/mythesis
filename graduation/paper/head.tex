...
% !TEX root = ..\paper.tex
\begin{abstractc}
\noindent \makebox[0pt][l]{\raisebox{8em}[0pt][0pt]{\songti\wuhao\textbf{ 学号：\skyauthorid}}}
...
\noindent \textbf{摘要：}\input{preface/mainc.tex}
}
\end{abstractc}
%\vspace{5mm}
...
\noindent \textbf{Abstract: } \input{preface/maine.tex}}
\end{abstracte}