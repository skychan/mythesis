...
\begin{figure}
\centering
\subfloat[Cyc -- ATC 算法调度结果]{\begin{tikzpicture}
...
\end{tikzpicture}}\\
\subfloat[Cyc -- Tabu 算法调度结果]{\begin{tikzpicture}
...
\end{tikzpicture}}\\
\subfloat[Vtr -- Tabu 算法调度结果]{\begin{tikzpicture}
...
\end{tikzpicture}}
\caption{$20$件订单的三种算法求解模型1 所得结果\label{fig:20items3algorithms}}
\end{figure}